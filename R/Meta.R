...
#'
#' @export
Meta.Read <- function(URL = "https://raw.githubusercontent.com/Senckenberg-DCBiodivIT/KrigR/add-alternative-data-source-DEDL/metadata/", ## change this to github repo for these data once ready
